...
Translations in languages other than English are machine translated and are not yet accurate. No errors have been fixed yet as of February 20th 2021. Please report translation errors [here](https://github.com/seanpm2001/Why-you-should-stop-using-Google-Accounts/issues/) look for the correct language translation thread. Make sure to backup your correction with sources and guide me, as I don't know languages other than English well (I plan on getting a translator eventually) please cite [wiktionary](https://en.wiktionary.org) and other sources in your report. Failing to do so will result in a rejection of the correction being published.

***

# Why you should stop using your Google Account(s)

![Google_account_icon.svg](Google_account_icon.svg)

This is an article on why you should stop using Google Accounts and find a different, privacy focused, and efficient provider.
...
Like other Google products, Google Accounts have a history of privacy and performance issues. Google offers some promising features, but it is just trying to cover for bad things going on behind the scenes. Don't let them think what they are doing is OK.

General description [from Wikipedia: Google Account](https://en.wikipedia.org/wiki/Google_Account) - Data from Februry 23rd 2021 at 8:58:32 pm (PT: Pacific Time)
...
Google Accounts are the same as all other Google products, it contains spyware, as Google is not just a search company, they are a user data company, and you are the product. To Google, you are only worth about $700.00 (unless you are making them ad revenue)

***

## Alternative solutions

Google Accounts are required to use most Google services. Once you degoogle, you won't need it anymore, just make sure not to have a single company have control over every productivity/entertainment site you use, because letting this happens just creates another monopoly like Google, and it can devastate the Internet (for example, when Google went down for 5 minutes in 2012, global Internet traffic dropped by 40% and Google is going down more frequently and for longer times due to bad management. This is a major issue as well, along with major privacy and performance issues across their products)

### Privacy focused

[Wikipedia](https://www.wikipedia.org) - Wikipedia only
...
File version: `1 (Tuesday, February 23rd 2021 at 9:11 pm)`
...
Version 1 (Tuesday, February 23rd 2021 at 9:11 pm)
